...
for island in sorted(sesource_map.key(), key=lambda x: travel_times.get(x, float('inf))): print(f"{island}: {resource_map[island]:.2f} shells (Travel Time: {travel_times[island]} hours)")
